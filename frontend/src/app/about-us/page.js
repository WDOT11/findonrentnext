...
export async function generateMetadata() {
  const meta = await getSeoMeta("/about-us/");
  return {
...
export default async function AboutUsPage() {
  const metaSchema = await getSeoMeta("/about-us/");
  return (
    <>

      {/* Preload Hero Background Image */}
      {/* <link rel="preload" as="image" href="/images/homepg/bg-img-3.svg" /> */}
      ...
      <section className={styles.roh_hero_wrap} aria-label="About FindOnRent rental platform" style={{ backgroundImage: "url('/images/homepg/bg-img-3.svg')", backgroundPosition: "center", backgroundSize: "cover", padding: "0 0"}}>
          ...
          <div className={`container ${styles.roh_hero_container}`}>
            <div className={styles.roh_hero_content}>
              ...
              <p className={styles.roh_pLarge}>
                FindOnRent was created with one simple goal. Make renting easy,
                transparent, and accessible for everyone. Today, we are one of
                the fastest growing rental platforms that connects customers
                with trusted local providers.
              </p>
              <p className={styles.roh_pLarge}>
                Whether someone needs a car for a trip, a bike for daily travel,
                a scooter for quick rides, or any other rental product,
                FindOnRent brings everything together in one place.
              </p>
      ...
      {/* Our Mission */}
      <section className={styles.roh_our_mission_wrap} aria-label="FindOnRent mission and values">
        <div className={styles.roh_container}>
          <div className="row align-items-center">
            <div className="col-12 col-md-6 col-lg-6">
              <h2>Our Mission</h2>
              <p>
                To simplify the rental process by offering a platform that gives
                customers real choice, transparent pricing, and direct access to
                verified providers. We believe renting should be quick,
                affordable, and free from hidden charges or middlemen.
              </p>
              <p className="mb-0">
                We are rewriting the rules of ownership by making access to
                premium vehicles and equipment easier than ever before.
              </p>
            </div>
            <div className="col-12 col-md-6 col-lg-6 mt-4 mt-md-0">
              <Image
                src="/images/assets/our-mission-about-us-img.webp"
                alt="FindOnRent mission to simplify vehicle and item rentals"
                width={640}
                height={438}
                style={{
                  width: "100%",
