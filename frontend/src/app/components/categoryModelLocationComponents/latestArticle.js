              ...
              <div className={`row g-4`}>
                ...
                {posts[0] && (
                  <div className={`col-md-12 col-lg-6`}>
                    <a href={`/blog/${posts[0].post_slug}`} className={`${styles.main_card} ${styles.htiscbox}`}
                ...
                <div className={`col-md-12 col-lg-6`}>
                  {posts.slice(1).map((post, index) => (
                    <a href={`/blog/${post.post_slug}`}  className={styles.sub_card} key={index}  aria-label={`Read article ${post.post_title}`}>
