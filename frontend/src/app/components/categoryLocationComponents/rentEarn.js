...
const RENT_EARN_CONTENT = {
  ...
  8: {
    ...
    darkDesc:
      "Turn your scooter into a daily earning asset with FindOnRent.",

    lightTitle: (
      <>
        Have a Scooter to Rent?{" "}
        <span style={{ color: "#ff3600" }}>
    ...
    points: [
      "Have a scooter that you don’t use daily?",
      "Want passive income from your scooter?",
      "Start your scooter rental journey today!",
    ],

    bottomTitle: "Convert your scooter into income with",
    bottomPeragraph: "India’s transparent marketplace for self-drive rentals.",
  },
  10: {
...
/* =========================
   COMPONENT
========================= */
export default async function RentEarn({ cate_id, cat_nm, loc_nm }) {
        ...
        <div className={styles.roh_rentEarn_inner}>
          ...
          <div className="px-4 px-sm-5 py-4 text-start bg-white m-auto">
            <h2 className="fw-bold mb-4 mt-0">
               Have a {cat_nm} to Rent Out in {loc_nm}? {" "}
                <span style={{ color: "#ff3600" }}>List it and Start Earning Today!</span>
            </h2>
            ...
            <ul className={`list-unstyled mb-4 ${styles.roh_rent_earn_list}`}>
                <li className="mb-2 d-flex align-items-center gap-2">
                  ...
                  <div>Do you have a {cat_nm} available for rent in {loc_nm}? </div>
                </li>
                <li className="mb-2 d-flex align-items-center gap-2">
                  <LuCircleCheck size={20} style={{ color: "#139c01" }} />
                  <div>Looking to provide your {cat_nm} for hire in {loc_nm}? </div>
                </li>
                <li className="mb-2 d-flex align-items-center gap-2">
                  <LuCircleCheck size={20} style={{ color: "#139c01" }} />
                  <div>Want to turn your idle {cat_nm} into a rental income?</div>
                </li>
            </ul>
            ...
            <h4 className="text-muted fw-medium mb-1">
              Turn your {cat_nm} into a steady source of income with{" "}
              <strong className="fw-bold text-dark">
                Find<span style={{ color: "#ff3600" }}>On</span>Rent
              </strong>
            </h4>
            <p>
              India’s transparent marketplace for rentals.{" "}
            </p>
          </div>
