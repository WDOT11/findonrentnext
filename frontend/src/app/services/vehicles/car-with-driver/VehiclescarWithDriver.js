"use client";
import "../../../globals.css";
import styles from "./car-with-driver.module.css";
...
export default function Vehiclescars() {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        const url = new URL(
          `${ROH_PUBLIC_API_BASE_URL}/getallvehiclescarswithdrivers`
        );
        url.searchParams.set("page", String(initialPage));
        url.searchParams.set("limit", String(limit));
        url.searchParams.set("cat_id", "10");
