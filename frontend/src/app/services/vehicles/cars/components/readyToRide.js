                            ...
                            <div className={`row`}>
                                <div className={`col-12 col-md-6 col-lg-6`}>
                                    <div className={`${styles.roh_singlePost_content}`}>
                                        <h3 className={`text-white mb-0 ${styles.roh_second_heading}`}>Need a car?<br /> Drive one today.</h3>
                                ...
                                <div className={`col-12 col-md-6 col-lg-6`}>
                                    <div className={`${styles.roh_singlePost_imgwrap}`}>
                                        <Image src="/images/vechiclespg/cta-car-img.png" alt='CTA Car' width={550} height={270} style={{ width: '100%', height: 'auto' }} />
