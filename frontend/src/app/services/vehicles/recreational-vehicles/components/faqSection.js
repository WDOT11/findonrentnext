...
import "../../../../globals.css";
import styles from "../../recreational-vehicles/components/faqSection.module.css";
...
export default function FAQSection({ cate_id }) {
  ...
  useEffect(() => {
    const fetchFaqs = async () => {
      try {
        setLoading(true);
        const res = await fetch(`${ROH_PUBLIC_API_BASE_URL}/getsinglecategoryrecentfaqs`, {
          method: "POST",
              ...
              <div className="row">
                ...
                <div className="col-12 col-md-12 col-lg-6 col-xl-6">
                  <div className={`${styles.faq_left_outer} pe-0 pe-md-4`}>
                    <Image
                      src="/images/vechiclespg/vehicles-recreational-vehicles-faq-img.webp"
                      width={550}
                      height={550}
                      alt="FAQ Image"
                    />
