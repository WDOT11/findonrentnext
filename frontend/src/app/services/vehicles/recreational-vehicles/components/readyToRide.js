                            ...
                            <div className={`row`}>
                                <div className={`col-12 col-md-6 col-lg-6`}>
                                    <div className={`${styles.roh_singlePost_content}`}>
                                        <h3 className={`text-white mb-0 ${styles.roh_second_heading}`}>Adventure ready. Book your RV today.</h3>
                                        ...
                                        <div className={`d-flex align-items-center justify-content-start roh_redBtns`}>
                                            <div className={`roh_button_custom`}><a href="/contact-us">Contact us</a></div>
                                            <div className={`roh_circl_btn`}>
                                                <a href="/contact-us"><Image src="/arrow.svg" alt="Arrow Right" width={30} height={30} /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className={`col-12 col-md-6 col-lg-6`}>
                                    <div className={`${styles.roh_singlePost_imgwrap}`}>
                                        <Image src="/images/vechiclespg/cta-recreational-vehiclesr-img.png" alt='CTA Recreational Vehicles' width={550} height={270} style={{ width: '100%', height: 'auto' }} />
